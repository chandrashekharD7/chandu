...
<body style="background-image:url('images/total1.jpg');background-opacity: 1;border-radius: 30px>
	...
	<div class="container"> 
		...
		<div class="row" style="margin-top: 4vw;" >
			<div class="col-md-3 col-sm-3 col-lg-3 col-xs-2 " ></div>
			    <div class="col-md-5 col-sm-7 col-xs-9 col-lg-5 " style="background-image:url('images/candi.jpg');background-opacity: 1;border-radius: 30px;"" >
					   <form action="" method="post">
				<h2 style="text-align: center;">ADMIN LOGIN	</h2>

						<div class="form-group">
							<input type="text" name="username" placeholder="Admin username" class="form-control"  style="border-radius: 30px; opacity:0.8;margin-top: 2vw;" required>
						</div>
						<div class="form-group">
							<input type="Password" class="form-control" placeholder="Password" name="password"  style="border-radius: 30px; opacity:0.8;" required>
						</div>
						<!-- <div class="form-group">
